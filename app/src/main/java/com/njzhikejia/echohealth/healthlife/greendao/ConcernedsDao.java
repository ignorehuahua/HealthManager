...
/** 
 * DAO for table "CONCERNEDS".
*/
public class ConcernedsDao extends AbstractDao<Concerneds, Void> {

    public static final String TABLENAME = "CONCERNEDS";

    /**
     * Properties of entity Concerneds.<br/>
    ...
    public ConcernedsDao(DaoConfig config) {
        super(config);
    }
    
    public ConcernedsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONCERNEDS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CONCERNEDS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Concerneds entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Concerneds entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getConcern_id());
        stmt.bindLong(2, entity.getUid());
    ...
    @Override
    public Concerneds readEntity(Cursor cursor, int offset) {
        Concerneds entity = new Concerneds( //
    ...
    @Override
    public void readEntity(Cursor cursor, Concerneds entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(Concerneds entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Concerneds entity) {
        return null;
    }

    @Override
    public boolean hasKey(Concerneds entity) {
        // TODO
        return false;
    }
