...
public class Extend {
    ...
    public Extend(int uid, int gov_flag, int nation, int community, int household,
            ...
            int toilet_ability, int move_ability, int revenue_level,
            String chronic_illness, String disability, String surgery_history,
            String irritability_history, String family_medical_history,
            String height, String weight, String bust, String waist, String hip,
            String remark, String readme, int constitution_type) {
        this.uid = uid;
    ...
    public String getIrritability_history() {
        return this.irritability_history;
    }
